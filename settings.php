<?php
	$adresa="Quality Dental Care 2801 South Fairfield Ave., Suite I Lombard, IL 60148"; //jako je vazno navesti dobro adresu radi boljeg poziciniranja
	$grad="";//jako je vazno ako adresa ima dva imena povezati ih sa plus
	$skracenica=""; // AKo ne znate skracenicu ostavite praznu
	$telephone=6305150900;// Broj koji se poziva na dugme CALL US
